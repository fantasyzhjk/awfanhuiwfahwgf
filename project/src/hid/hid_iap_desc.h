...
#define USBD_HIDIAP_VENDOR_ID            0x5D3E
#define USBD_HIDIAP_PRODUCT_ID           0xFA00

#define USBD_HIDIAP_CONFIG_DESC_SIZE     41
#define USBD_HIDIAP_SIZ_REPORT_DESC      32
#define USBD_HIDIAP_SIZ_STRING_LANGID    4
#define USBD_HIDIAP_SIZ_STRING_SERIAL    34

#define USBD_HIDIAP_DESC_MANUFACTURER_STRING    "desu.life"
#define USBD_HIDIAP_DESC_PRODUCT_STRING         "ARM IAP"
#define USBD_HIDIAP_DESC_CONFIGURATION_STRING   "ARM IAP Config"
#define USBD_HIDIAP_DESC_INTERFACE_STRING       "ARM IAP Interface"
